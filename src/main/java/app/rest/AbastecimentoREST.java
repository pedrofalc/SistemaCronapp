...
public class AbastecimentoREST {
  ...
  public Abastecimento put(@PathVariable("id") final java.lang.String id, @Validated @RequestBody final Abastecimento entity) throws Exception {
    return abastecimentoBusiness.put(entity);
  }
  ...
  public void delete(@PathVariable("id") java.lang.String id) throws Exception {
    abastecimentoBusiness.delete(id);
  }
